    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-button type="primary" @click="e=>updateClient(e)">
            <span >确定</span>
          </a-button>
        </a-form-item>
      </a-form>
...
export default {
  ...
  methods: {
    ...
    async queryClientById () {
      this.confirmLoading = true
      await getClientById({ id: this.query.id }).then(res => {
    ...
    updateClient (e) {
      ...
      this.form.validateFields((err, values) => {
        ...
        updateClient(this.query).then(res => {
